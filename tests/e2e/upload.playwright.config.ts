...
import { loadUploadBrowserFixture } from './workspace-upload-fixtures';
const fixture = loadUploadBrowserFixture();
export default defineConfig({
  testDir: '.', testMatch: 'workspace-upload.spec.ts', fullyParallel: false, workers: 1,
  retries: 0, forbidOnly: true, timeout: 180_000, expect: { timeout: 15_000 },
